...
function sumArray(testArray){ //eslint-disable-line
  var sumB = sum(sum(testArray[0],testArray[1])[0], testArray[2])[0];
  var sumBText = (testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumB + ' is their sum.');
  return [sumB, sumBText];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var multiplyB = multiply(multiply(testArray[0],testArray[1])[0], testArray[2])[0];
  var multiplyBText = ('The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multiplyB + '.');
  return [multiplyB, multiplyBText];
}
